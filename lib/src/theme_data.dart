...
class ThemeData extends Diagnosticable {
  factory ThemeData({
    ...
    buttonOutlineColor ??= isDark ? primarySwatch[600] : Colors.grey[400];
    focusColor ??= isDark
  ...
  ThemeData copyWith({
    ...
    return ThemeData.raw(
      ...
      buttonOutlineColor: buttonOutlineColor ?? this.buttonOutlineColor,
  ...
  static ThemeData lerp(ThemeData a, ThemeData b, double t) {
    ...
    return ThemeData.raw(
      ...
      buttonOutlineColor:
          Color.lerp(a.buttonOutlineColor, b.buttonOutlineColor, t),
  ...
  bool operator ==(Object other) {
    ...
    return (otherData.brightness == brightness) &&
        ...
        (otherData.buttonOutlineColor == buttonOutlineColor) &&
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    ...
    properties.add(ColorProperty('buttonOutlineColor', buttonOutlineColor,
        defaultValue: defaultData.buttonOutlineColor));
